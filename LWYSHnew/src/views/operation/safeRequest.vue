<template>
    <section class="sec-box">
        ...
        <el-col :span="24" class="toolbar fil-tool" style="padding-bottom: 0px;">
            ...
            <el-form  :model="filters" ref="filters" id="filterss" class="filters colborder" label-width="100px">
            	<el-col :span="6">
                ...
                <el-col :span="6">
                    <el-form-item label="检验结论:"  prop="jyjl">
                        <el-select v-model="filters.jyjl" placeholder="全部">
                           <el-option label="合格" value="0"></el-option>
                           <el-option label="不合格" value="1"></el-option>
                        </el-select>
                    </el-form-item>
                </el-col>
                <el-col :span="12" class="time-box">
                    <el-form-item label="检测时间:"  required >
                        <el-col :span="12">
                            <el-form-item prop="jykssj">
                                <el-date-picker
	                    ...
	                    <el-col :span="12">
		                    <el-form-item  prop="jyjzsj" >
		                        <el-date-picker style="border-left:none"
        ...
        <div class="list-box">
            ...
            <el-table :data="users" highlight-current-row v-loading="listLoading" @row-dblclick="openDetails" @selection-change="selsChange" style="width: 100%">
                ...
                <el-table-column prop="jylsh"   label="检验流水号" width="200px">
                </el-table-column>
                <el-table-column prop="jyjgbh"   label="检验机构名称" width="200px">
                </el-table-column>
                <el-table-column prop="jylb" label="检验类别" width="200px">
                    <template slot-scope="scope">
                        <span>{{scope.row.jylb | jylbDate }}</span>
                    </template>
                </el-table-column>
                <el-table-column prop="hphm"   label="号牌号码" width="120px">
                </el-table-column>
                <el-table-column prop="hpzlmc"   label="号牌种类" >
                </el-table-column>
                <el-table-column prop="cllxmc"   label="车辆类型" width="120px">
                </el-table-column>
                <el-table-column prop="jyrq"   label="检验日期" width="200px">
                    <template slot-scope="scope">
                ...
                <el-table-column prop="lszt"  width="140" label="流水状态">
                	<template slot-scope="scope">
                		<span>{{scope.row.lszt | lstFilters}}</span>
                	</template>
                </el-table-column>
                <el-table-column label="操作" width="120px" fixed="right">
						<template slot-scope="scope">
							<el-button type="danger"  size="small" @click="openDetails(scope.row)">详情</el-button>
						</template>
					</el-table-column>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            btnDetail(row) {
                console.log(row);
                sessionStorage.setItem('requestdate', JSON.stringify(row));
                this.$router.push('/RequestMore')
            ...
            openDetails(row) {
                ...
                var winObj = window.open(href,"shWindow","menubar=0,scrollbars=1, resizable=1,status=1,titlebar=0,toolbar=0,location=1");
