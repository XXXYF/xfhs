        ...
        <el-col :span="24" class="toolbar fil-tool" style="padding-bottom: 0px;">
            ...
            <el-form  :model="filters" ref="filters" :rules="filtersValid" id="filterss" class="filters" label-width="260px">
                ...
                <el-col :span="24" class="selectBtnbox">
                    <el-button  class="dialog-button search-button"  @click.native.prevent="changerole">修改</el-button>
...
<script>
    ...
    export default {
                ...
                this.$refs.filters.validate((valid) => {
                    if (valid) {
                        this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            axios.post('api/sys/jsgl/update', qs.stringify(para) ,{
                                headers: {
                                ...
                                sessionStorage.setItem('roleMsg',JSON.stringify(para))
        ...
        mounted() {
            //获取消息
            var roleMsg = sessionStorage.getItem('roleMsg');
            console.log(roleMsg,'456')
            if (roleMsg) {
                roleMsg = JSON.parse(roleMsg);
                this.filters = roleMsg || '';
