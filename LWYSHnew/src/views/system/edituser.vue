            ...
            <el-form  :model="filters" ref="filters" :rules="filtersValid" id="filterss" class="filters" label-width="260px">
                <el-col :span="12" class="colborder">
                    <el-form-item label="用户名:" prop="yhbh">
                        <el-input v-model="filters.yhbh" placeholder=""  :maxlength="10" :disabled="true"  ></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12" class="colborder">
                ...
                <el-col :span="12" class="colborder">
                    <el-form-item label="用户身份证号码:" prop="yhsfzh"  :maxlength="30">
                        <el-input v-model="filters.yhsfzh" placeholder=""   ></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12" class="colborder">
                ...
                <el-col :span="24" class="selectBtnbox">
                    <el-button v-if="filters.yhzt === '1'" class="dialog-button enjoin-button" @click="enjoin">禁用</el-button>
                    <el-button v-if="filters.yhzt  === '2'" class="dialog-button enjoin-button" @click="enjoin2">启用</el-button>
                    <!--<el-button class="dialog-button enjoin-button" @click="enjoin">禁用</el-button>-->
                    <el-button class="dialog-button password-button" @click="changepassword">重置密码</el-button>
                    <el-button  class="dialog-button search-button"  @click.native.prevent="changeUser">修改</el-button>
    ...
    export default {
            ...
            return {
                ...
                filtersValid:{
                    ...
                    yhyxq: [
                        ...
                        { required: true, message: '请输入用户有效期', trigger: 'blur' },
                    ],
                    mmyqx: [
        ...
        methods: {
            ...
            changeUser:function () {
                ...
                console.log(this.filters.yhyxq)
                console.log(this.filters.mmyqx)
                this.$refs.filters.validate((valid) => {
                    if (valid) {
                        this.$confirm('确认修改吗？', '提示', {}).then(() => {
                            ...
                            axios.post('api/sys/yhgl/update', qs.stringify(para) ,{
                                headers: {
                                ...
                                sessionStorage.setItem('editMsg',JSON.stringify(para))
            ...
            changepassword:function () {
                this.$confirm('确认重置吗？', '提示', {}).then(() => {
                    let para = {
                        yhbh: this.filters.yhbh
                    };
                    console.log(para);
                    var qs = require('querystring')
                    axios.post('api/sys/yhgl/resetPwd', qs.stringify(para) ,{
                        headers: {
                            "Content-Type" :" application/x-www-form-urlencoded; charset=UTF-8",
                        },
                        withCredentials:true,
        ...
        mounted() {
            ...
            console.log(editMsg,'9999999999')
            if (editMsg) {
                editMsg = JSON.parse(editMsg);
                editMsg.yhjs = parseInt(editMsg.yhjs);
                this.glbmbhdata. push(editMsg.bmbh);
                this.filters = editMsg || '';
            };
