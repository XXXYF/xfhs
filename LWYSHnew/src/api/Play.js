...
function PlayVideo(url, index) {
	$("#divright").show();
	var hphm = $("#hphm" + index).val();
	$("#hphm").val(hphm);
	var jylsh = $("#jylsh" + index).val();
	$("#jclsh").val(jylsh);
	var jczmc = $("#jczmc" + index).val();
	$("#jyjgmc").val(jczmc);
	var jyjgbh = $("#jyjgbh" + index).val();
	$("#jyjgbh").val(jyjgbh);
	var hpzl = $("#hpzl" + index).val();
	$("#hpzl").val(hpzl);
	var jcxdh = $("#jcxdh" + index).val();
	$("#jcxdh").val(jcxdh);
	var hpzlm = $("#hpzlm" + index).val();
	$("#hpzlm").val(hpzlm);
	var jycs = $("#jycser" + index).val();
