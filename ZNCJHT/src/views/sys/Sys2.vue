	...
	<section class="sec-box">
		...
		<el-col :span="24" class="toolbar fil-tool" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters" ref="filters" id="filters" label-width="100px" >
				<el-form-item label="视频区域:">
					<el-select v-model="filters.name" placeholder="全部">
						<el-option label="警员" value="0"></el-option>
						<el-option label="非警员" value="1"></el-option>
						<el-option label="机构业务人员" value="2"></el-option>
					</el-select>
				</el-form-item>
		...
		<div class="list-box">
			<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
				<el-table-column prop="useid" label="检测区域" >
				</el-table-column>
				<el-table-column prop="name" label="检测线号">
				</el-table-column>
				<el-table-column prop="department" label="视频名称" >
				</el-table-column>
				<el-table-column prop="useid" label="通道号" >
				</el-table-column>
				<el-table-column prop="name" label="视频ip">
				</el-table-column>
				<el-table-column prop="department" label="端口" >
				</el-table-column>
				<el-table-column prop="useid" label="用户名" >
				</el-table-column>
				<el-table-column prop="name" label="用户密码">
				</el-table-column>
				<el-table-column prop="department" label="摄像抓拍" >
				</el-table-column>
