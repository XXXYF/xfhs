	...
	<section class="sec-box">
		...
		<el-col :span="24" class="toolbar fil-tool" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters" ref="filters" id="filters" label-width="96px">
				<el-form-item label="备案编号:">
					<el-input v-model="filters.name" placeholder="请输入备案编号"></el-input>
				</el-form-item>
		...
		<div class="list-box">
			<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
				...
				<el-table-column prop="role" label="检测系统名称" :formatter="formatRole" width="150" text-align="center">
				</el-table-column>
				<el-table-column prop="name" label="开发单位">
				</el-table-column>
				<el-table-column prop="type" label="审核标记" :formatter="formatType">
				</el-table-column>
	...
	export default {
		...
		methods: {
			...
			detailbtn: function (index, row){
				...
				this.$router.push({path:'/CheSysDt'})
