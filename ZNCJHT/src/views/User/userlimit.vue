<template>
	<section class="sec-box">
		...
		<el-col :span="24" class="btn-box">
			<p><el-button type="primary" @click="handleAdd">新增权限</el-button></p>
		...
		<div class="list-box">
			<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
				<el-table-column prop="useid" label="权限名称" >
				</el-table-column>
				<el-table-column prop="name" label="权限标识">
				</el-table-column>
				<el-table-column prop="department" label="请求路径" >
				</el-table-column>
				<el-table-column prop="roleid" label="所属模块">
				</el-table-column>
				<el-table-column prop="role" label="特征" :formatter="formatRole" text-align="center">
				</el-table-column>
